...
| ★★☆ | [A Passion for Mathematics - Numbers, Puzzles, Madness, Religion, and the Quest for Reality](https://pdfhost.io/v/TWr7I2RjA_A_Passion_for_Mathematics_Numbers_Puzzles_Madness_Religion_and_the_Quest_for_Reality_by_Clifford_A_Pickover_zliborg), by Clifford A. Pickover | This book is meant to be a textbook for an introductory combinatorics course that can take one or two semesters. It covers the classics, that is, combinato-rial choice problems, and graph theory. A must-read book to excel in CP. |
