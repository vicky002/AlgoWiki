...
A curated list of Deep Learning (DL) courses, books, video lectures and papers.

Contributions most welcome.

## Index
- [Online Courses](#online-courses)
- [Books About Deep Learning](#books-about-deep-learning)
- [Papers](#Papers)
- [YouTube Channels To Follow](#Youtube-channel-to-follow)
...
five-course specialization will help you understand Deep Learning fundamentals, apply them, and build a career in AI.
...
2. [Neural Networks and Deep Learning by Michael Nielsen](neuralnetworksanddeeplearning) 
3. [Deep Learning with Python by Francois Chollet](https://www.amazon.com/Deep-Learning-Python-Francois-Chollet/dp/1617294438) 
4. [Hands-On Machine Learning with Scikit-Learn, Keras and Tensor Flow by Aurelien Geron](https://www.amazon.in/Hands-Machine-Learning-Scikit-Learn-Tensor/dp/9352135210) 
5. [Grooking Deep Learning by Andrew Trask](https://www.manning.com/books/grokking-deep-learning) 
...
3. [Data School](https://www.youtube.com/user/dataschool)
4. [Luis Serrano](https://www.youtube.com/channel/UCgBncpylJ1kiVaPyP-PZauQ)
5. [StatQuest with Josh Starmer](https://www.youtube.com/user/joshstarmer) 
6. [Deep Lizard](https://www.youtube.com/channel/UC4UJ26WkceqONNF5S26OiVw)
7. [Jeremy Howard](https://www.youtube.com/user/howardjeremyp) 

[⬆ Back to Top](#index)

## Videos/Talks

1. [The Unreasonable Effectiveness of Deep Learning](https://www.youtube.com/watch?v=sc-KbuZqGkI) - The Director of Facebook's AI Research, Dr. Yann LeCun gives a talk on deep convolutional neural networks and their applications to machine learning and computer vision
...
141.[Deep Learning Tutorial Series](https://medium.com/intro-to-artificial-intelligence/deep-learning-series-1-intro-to-deep-learning-abb1780ee20) - Contains one of the easiest explainations of Deep Learning.
[⬆ Back to Top](#index)
